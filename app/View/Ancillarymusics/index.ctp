<div class="ancillarymusics index">
	<!--
	<h2><?php echo __('Ancillarymusics'); ?></h2>
	-->
	<h2><?php echo 'Recordings ancillary music'; ?></h2>
	...
	<?php foreach ($ancillarymusics as $ancillarymusic): ?>
	<tr>
		<td><?php echo h($ancillarymusic['Ancillarymusic']['id']); ?>&nbsp;</td>
		<td><?php echo h($ancillarymusic['Ancillarymusic']['name']); ?>&nbsp;</td>
